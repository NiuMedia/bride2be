(function() {
  ...
  BootLoader = (function() {
        ...
        if (window.location.href.search("simulator_start") !== -1) {
          ...
          if (window.location.href.search("initial_start") !== -1) {
            if (_this.previousApplicationJSONString != null) {
              if ((JSON.parse(_this.previousApplicationJSONString).path != null) && JSON.parse(_this.previousApplicationJSONString).path !== "") {
    ...
    BootLoader.prototype.load = function() {
      ...
      this.application_json.startup_link = this.previousLink;
