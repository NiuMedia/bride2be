...
(function() {
  ...
  window.Studio = (function() {
    ...
    Studio.prototype.start_polling = function() {
      var _this = this;
        ...
        if (_this.host !== "livepreview.appgyver.com") {
          ...
          return _this.get_application_json(true, function(json) {
            ...
            return _this.poll_studio_for_refresh(function() {
              if (_this.debug) console.log("refresh should happen");
    ...
    Studio.prototype.poll_studio_for_refresh = function(callback) {
      ...
      this.xhr = new XHR(refresh_url, {
        success: function(response) {
          if (_this.debug) console.log("Refresh poll: " + response);
          _this.xhr.close();
          if (response) {
            if (_this.debug) console.log("Refreshing.");
            return callback.call();
          } else {
            return setTimeout(function() {
              _this.xhr.reopen();
              return _this.xhr.send();
            }, 1000);
          }
        },
        failure: function() {
